...
function() {
    ...
    function o(o, r) {
        var e, n, t = "auto" === o.paths,
        s = (e = o.namespace) ? u.EXPIRE_KEY + "/" + e: u.EXPIRE_KEY,
        c = (n = o.namespace) ? u.INDEX_KEY + "/" + n: u.INDEX_KEY,
        a = localStorage.getItem(s) < Date.now();
        if (f = JSON.parse(localStorage.getItem(c)), a) f = {};
        else if (!t) return;
        var i, d, l = t ? (i = r.router, d = [], Docsify.dom.findAll(".sidebar-nav a:not(.section-link):not([data-nosearch])").forEach(function(e) {
            var n = e.href,
        ...
        l.forEach(function(i) {
            ...
            Docsify.get(r.router.getFile(i), !1, r.config.requestHeaders).then(function(e) {
                ...
                f[i] = function(n, e, t, a) {
                    ...
                    r.clear(),
                    s
                } (i, e, r.router, o.depth),
                h === ++p && (n = o.maxAge, t = s, a = c, localStorage.setItem(t, Date.now() + n), localStorage.setItem(a, JSON.stringify(f)))
            })
        })
    }
    var c, d = "";
    function s(e) {
        ...
        t.innerHTML = "",
        void(c.hideOtherSidebarContent && (i.classList.remove("hide"), o.classList.remove("hide")));
        var r = function(e) {
            var i = [],
            o = [];
            ...
            var r = (e = e.trim()).split(/[\s\-，\\/] + /);1!==r.length&&(r=[].concat(e,r));for(var n=function(e){var n=o[e],s=0,c="",d=n.title&&n.title.trim(),l=n.body&&n.body.trim(),t=n.slug||"";if(d&&(r.forEach(function(e){var n,t=new RegExp(e.replace(/ [ | \\ {} ()[\] ^ $ + *?.] / g,
            "\\$&"),
            "gi"),
            a = -1;
            if (n = d ? d.search(t) : -1, a = l ? l.search(t) : -1, 0 <= n || 0 <= a) {
                s += 0 <= n ? 3 : 0 <= a ? 2 : 0,
                a < 0 && (a = 0);
                var i, o = 0; (o = 0 == (i = a < 11 ? 0 : a - 10) ? 70 : a + e.length + 60) > l.length && (o = l.length);
                var r = "..." + h(l).substring(i, o).replace(t, '<em class="search-keyword">' + e + "</em>") + "...";
                c += r
            }
        }), 0 < s)) {
            var a = {
...
function r(e, n) {
    var t, a, i, o, r = n.router.parse().query.s;
    l(e),
    ...
    a = Docsify.dom.find("div.search"),
    i = Docsify.dom.find(a, "input"),
    o = Docsify.dom.find(a, ".input-wrap"),
    Docsify.dom.on(a, "click",
    function(e) {
        return "A" !== e.target.tagName && e.stopPropagation()
    }),
    Docsify.dom.on(i, "input",
    function(n) {
        clearTimeout(t),
